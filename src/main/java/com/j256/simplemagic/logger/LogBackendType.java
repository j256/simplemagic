...
public enum LogBackendType implements LogBackendFactory {
	 ...
	 */
	SLF4J("com.j256.simplemagic.logger.backend.Slf4jLoggingLogBackend$Slf4jLoggingLogBackendFactory"),
	/**
	 * Logback direct. See: http://logback.qos.ch/
	 */
	LOGBACK("com.j256.simplemagic.logger.backend.LogbackLogBackend$LogbackLogBackendFactory"),
	/**
	 * Apache commons logging. See https://commons.apache.org/proper/commons-logging/
	 */
	COMMONS_LOGGING("com.j256.simplemagic.logger.backend.CommonsLoggingLogBackend$CommonsLoggingLogBackendFactory"),
	/**
	 * Version 2 of the log4j package. See https://logging.apache.org/log4j/2.x/
	 */
	LOG4J2("com.j256.simplemagic.logger.backend.Log4j2LogBackend$Log4j2LogBackendFactory"),
	/**
	 * Old version of the log4j package. See https://logging.apache.org/log4j/2.x/
	 */
	LOG4J("com.j256.simplemagic.logger.backend.Log4jLogBackend$Log4jLogBackendFactory"),
	/**
	 ...
	 */
	JAVA_UTIL("com.j256.simplemagic.logger.backend.JavaUtilLogBackend$JavaUtilLogBackendFactory"),
	/**
