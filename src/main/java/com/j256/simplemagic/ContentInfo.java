...
public class ContentInfo implements Serializable {
	...
	/**
	 * Create a ContentInfo given the following details
	 * 
	 * @param name  A name
	 * @param mimeType A mimetype
	 * @param message  An output message
	 * @param partial  Whether it is a partial match
	 */
	...
	/**
	 * Create a ContentInfo from a given ContentType 
	 ...
	 * 
	 * @return the internal enumerated type associated with the content or {@link ContentType#OTHER} if not known.
	 */
	 ...
	 * library knows about.
	 * 
	 * @return whether this is a partial match or not
	 */
