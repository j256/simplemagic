...
public class Formatter {
	...
	private final static String FINAL_PATTERN_CHARS = "%bcdeEfFgGiosuxX";
	private final static String PATTERN_MODIFIERS = "lqh";
	...
	/**
	 * Representation of our percent expression.
	 */
	private static class PercentExpression {

		private final static Pattern FORMAT_PATTERN = Pattern.compile("%([0#+ -]*)([0-9]*)(\\.([0-9]+))?(["
				+ PATTERN_MODIFIERS + "]*)([" + FINAL_PATTERN_CHARS + "])");
		...
		public PercentExpression(String expression) {
